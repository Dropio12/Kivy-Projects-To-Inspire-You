...
class MainApp(App):
    colors = QueryDict()
    colors.primary = rgba("#2A194E")
    colors.secondary = rgba("#601DEF")
    colors.success = rgba("#1FC98E")
    colors.warning = rgba("#F2C94C")
    colors.danger = rgba("#EB5757")
    colors.tertiary = rgba("#E9F3FB")
    colors.tertiary_light = rgba("#F1F6FA")
    colors.grey_dark = rgba("#c4c4c4")
    colors.grey_light = rgba("#f5f5f5")
    colors.black = rgba("#a1a1a1")
    colors.white = rgba("#ffffff")
    colors.gradient = [rgba("#D7E4EF"), rgba("#ffffff")]
    colors.gradient_opaque = [rgba("#ffffff"), rgba("#D7E4EF00")]
    colors.gradient_invert = [rgba("#ffffff"), rgba("#D7E4EF")]
